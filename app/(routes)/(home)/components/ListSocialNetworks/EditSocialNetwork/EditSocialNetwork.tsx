          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Link from {link.name}</FormLabel>
                    <FormControl>
                      <Input placeholder="https://domain/@nvrz" {...field} />
                    </FormControl>
                    <FormDescription>
                      Example: https://domain/@nvrz
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <Button type="submit" className="w-full bg-violet-500">Save</Button>
            </form>
          </Form>
        </DialogHeader>
      </DialogContent>
