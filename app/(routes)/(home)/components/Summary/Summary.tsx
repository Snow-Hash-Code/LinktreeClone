...
export function Summary(props: SummaryProps) {
  ...
  return (
    <div>
      <h2 className="text-center font-semibold text-2xl">Your nvrzTree is ready!</h2>
      <p className="text-center">It&apos;s time to share to the world</p>
        ...
        <div>
          ...
          <div className="space-y-3 mt-4">
            {platforms.map((platform) => (
              <div key={platform.name} className="flex istems-center gap-2">
                <Image 
                  src={platform.icon}
                  alt="platform"
                  width={25}
